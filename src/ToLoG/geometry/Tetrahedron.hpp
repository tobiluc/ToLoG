...
public:
    ...
    const P& operator[](const int& _i) const {
        return t_[_i];
    }
    P& operator[](const int& _i) {
        return t_[_i];
    }
    const P& operator[](const TetTopology::V& _v) const {
        return t_[TetTopology::i(_v)];
    }
    P& operator[](const TetTopology::V& _v) {
        return t_[TetTopology::i(_v)];
    }
    Segment<P> segment(int _i, int _j) const {
        return Segment<P>(t_[_i], t_[_j]);
    }
    Segment<P> segment(const TetTopology::HE& _he) const {
        return Segment<P>(
            this->operator[](TetTopology::v0(_he)),
            this->operator[](TetTopology::v1(_he)));
    }
    Triangle<P> triangle(int _i, int _j, int _k) const {
        return Triangle<P>(t_[_i], t_[_j], t_[_k]);
    }
    Triangle<P> triangle(const TetTopology::HF& _hf) const {
        return Triangle<P>(
            this->operator[](TetTopology::v0(_hf)),
            this->operator[](TetTopology::v1(_hf)),
            this->operator[](TetTopology::v2(_hf)));
    }
    bool operator==(const Tetrahedron<P>& _tet) const {
        return    t_[0] == _tet[0]
               && t_[1] == _tet[1]
               && t_[2] == _tet[2]
               && t_[3] == _tet[3];
