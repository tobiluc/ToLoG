...
//     map["Three"] = "troi";
//     EXPECT_EQ(map.get("Three")->get(), "troi");
// }

// TEST(HashMapTest, IteratorTest)
// {
//     HashMap<int, double> half;
//     half[3] = 1.5;
//     half[19] = 8.5;
//     half[7] = 3.5;
...
//     EXPECT_EQ(1.5, (*it).second);
//     ++it;
//     EXPECT_EQ(19, (*it).first);
//     EXPECT_EQ(8.5, (*it).second);
//     ++it;
//     EXPECT_EQ(7, (*it).first);
//     EXPECT_EQ(3.5, (*it).second);
//     ++it;
//     EXPECT_EQ(it, half.end());
// }
